...
// configuration step. It creates a namespace called `grandrounds`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        grandrounds::cmake::project_name,
        grandrounds::cmake::project_version));// version string, acquired
